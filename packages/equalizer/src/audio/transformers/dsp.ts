...
export function applyPulsator(config: AFPulsatorConfig, int: number, channel: LR) {
...
export function applyTremolo(config: AFTremoloConfig, int: number, sampleRate: number) {
