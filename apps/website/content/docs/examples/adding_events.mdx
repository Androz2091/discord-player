...
[List of all available events](/docs/discord-player/type/GuildQueueEvents)
...
<Callout type="info">
  For this example to work, you will need to pass `interaction.channel` as the metadata while executing the play
