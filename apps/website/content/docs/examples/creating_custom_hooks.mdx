...
Hooks allow you to quickly perform actions on the queue or its components. Discord Player comes with some general purpose hooks, which can be found [here](/guide/hooks/using-hooks).
