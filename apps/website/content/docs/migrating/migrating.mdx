...
<Callout>In order to access hooks via context api, you must not provide arguments to the hooks.</Callout>
...
<Callout>
  The hooks will not work outside the context scope. If you want to use hooks outside the context scope, you have to
  provide the arguments manually.
</Callout>
