...
See <Link className="text-teal-500 hover:underline" href="/guide?topic=Extractors&page=Stream%2520Sources">Stream Sources</Link> for more information.
...
In order to use `SoundCloud` as the `BridgeProvider` source, you need to register the `SoundCloudExtractor` first. See <Link className="text-teal-500 hover:underline" href="/guide?topic=Extractors&page=Setting%2520Bridge%2520Source">Setting Bridge Source</Link> for more information.
