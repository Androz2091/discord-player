...
Also this does not perform checks on the current status of the queue. Refer to one of the [example bots](/showcase) for more detailed info.
...
You can find the whole list of available nodeOptions from [GuildNodeCreateOptions](https://discord-player.js.org/docs/discord-player/type/GuildNodeCreateOptions)
