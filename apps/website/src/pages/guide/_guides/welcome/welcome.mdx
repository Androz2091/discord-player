...
<div class="flex flex-row gap-2 my-2">
    <a class="underline font-semibold text-teal-500 hover:text-teal-600" target="_blank" rel="noopener noreferrer" href="/guide/[topic]/[page]">
        <img src="https://img.shields.io/npm/dt/discord-player?style=for-the-badge" alt="downloadsBadge" />
    </a>
    <a class="underline font-semibold text-teal-500 hover:text-teal-600" target="_blank" rel="noopener noreferrer" href="https://npmjs.com/discord-player">
        <img src="https://img.shields.io/npm/v/discord-player?style=for-the-badge" alt="versionBadge" />
    </a>
    <a class="underline font-semibold text-teal-500 hover:text-teal-600" target="_blank" rel="noopener noreferrer" href="https://androz2091.fr/discord">
