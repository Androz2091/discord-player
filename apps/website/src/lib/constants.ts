...
export const tools: ITools[] = [
    ...
    },
    {
        ...
        description:
            'Discord Player leverages ffmpeg, a comprehensive multimedia framework, to handle audio encoding, decoding, and streaming. It ensures efficient and high-quality audio playback.',
    },
    {
        title: 'discord-voip',
...
export const DISCORD_ICON =
    'https://cdn.discordapp.com/icons/558328638911545423/54b69e440728a954e3e52b54f3206894.webp?size=128';
