    ...
    bots: PromotedList.bots.concat(
        [
            ...
            },
            {
                ...
                description:
                    'A feature-rich discord music bot with Button control; support for YouTube, SoundCloud, Spotify, Apple music; 25+ Audio filters, Equalizer; and is easy to self-host with Docker.',
                version: 'v6.7.1',
