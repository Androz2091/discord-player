...
| playerSkip | (queue: GuildQueue\<Meta>, track: Track\<unknown>) => unknown | N/A | Emitted when the audio player skips current track |
...
- [Source](https://github.com/Androz2091/discord-player/blob/f2dbc02/packages/discord-player/src/manager/GuildQueue.ts#L170)