## VolumeTransformer extends Transform
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L12)
### private  _bytes: number
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L14)
### private  _chunk: null \| Buffer
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L16)
### private  _extremum: number
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L15)
### private  _smoothing: number
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L13)
### private  _targetVolume: number
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L18)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L19)
### public  volume: number
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L17)
...
### public  hasSmoothness: boolean

### public  smoothness: number

### public  volumeDecibels: number

### public  volumeLogarithmic: number

### public  hasSmoothing: boolean

## Methods
### public  \[asyncIterator](): AsyncIterableIterator\<any>
- Source: `node_modules/@types/node/stream.d.ts#L502`
### public  _applySmoothness(): void
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L63)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L96)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L56)
### public  _transform(chunk, encoding, done): unknown
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| chunk | Buffer | ❌ | - |
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L71)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L59)
...
### public  setSmoothness(smoothness): void
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| smoothness | number | ❌ | - |


- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L129)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L101)
### public  setVolumeDecibels(db): void
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| db | number | ❌ | - |


- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L109)
### public  setVolumeLogarithmic(value): void
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| value | number | ❌ | - |


- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L113)
### public  smoothingEnabled(): boolean
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/discord-player/src/VoiceInterface/VolumeTransformer.ts#L133)
### public  uncork(): void
...
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| src | string \| Object \| Stream \| Promise\<any> \| Blob \| ArrayBuffer \| Iterable\<any> \| AsyncIterable\<any> \| AsyncGeneratorFunction | ❌ | - |
