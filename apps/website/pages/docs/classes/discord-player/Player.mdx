...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L32)
### public events: PlayerEventsEmitter\<GuildQueueEvents\<unknown>>
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L37)
### public extractors: ExtractorExecutionContext
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L36)
### public id: string
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L31)
### public nodes: GuildNodeManager\<unknown>
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L34)
### public options: PlayerInitOptions
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L33)
### public requiredEvents: Array\<keyof PlayerEvents>
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/utils/PlayerEventsEmitter.ts#L7)
### public voiceUtils: VoiceUtils
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L35)
### public static _singletonKey: symbol
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L30)
### public static defaultMaxListeners: number

### public static version: string
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L29)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L622)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L630)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L102)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L192)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/utils/PlayerEventsEmitter.ts#L11)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L176)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L306)
### public isVoiceStateHandlerLocked(): boolean
Checks if voice state handler is locked.



- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L327)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L313)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L348)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L590)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L410)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L320)
### public static clearAllPlayers(): void
Clear all master player instances



- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L128)
### public static getAllPlayers(): Array\<Player>
Get all active master player instances



- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L121)
...
- [Source](https://github.com/Androz2091/discord-player/blob/97a849a/packages/discord-player/src/Player.ts#L111)