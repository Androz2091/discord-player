...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L47)
### public events: PlayerEventsEmitter\<GuildQueueEvents\<unknown>>
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L52)
### public extractors: ExtractorExecutionContext
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L51)
### public id: string
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L46)
### public nodes: GuildNodeManager\<unknown>
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L49)
### public options: PlayerInitOptions
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L48)
### public requiredEvents: Array\<keyof PlayerEvents>
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/utils/PlayerEventsEmitter.ts#L7)
### public voiceUtils: VoiceUtils
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L50)
### public static _singletonKey: symbol
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L45)
### public static defaultMaxListeners: number

### public static version: string
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L44)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L564)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L572)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L129)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L219)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/utils/PlayerEventsEmitter.ts#L11)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L203)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L256)
### public isVoiceStateHandlerLocked(): boolean
Checks if voice state handler is locked.



- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L277)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L263)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L125)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L298)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L532)
...
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| query | string \| Track\<unknown> \| Playlist \| Array\<Track\<unknown>> \| SearchResult | ❌ | The search query |
| options | SearchOptions | ❌ | The search options |


- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L352)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L270)
### public static clearAllPlayers(): void
Clear all master player instances



- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L155)
### public static getAllPlayers(): Array\<Player>
Get all active master player instances



- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L148)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e2a9cfc/packages/discord-player/src/Player.ts#L138)