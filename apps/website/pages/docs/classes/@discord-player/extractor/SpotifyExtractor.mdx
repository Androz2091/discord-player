...
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L10)
### private  _stream: StreamFN
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L9)
...
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L8)
### public  identifier: string
Identifier of this extractor
## Methods
### public  activate(): Promise\<void>
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L12)
...
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L22)
...
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L125)
...
- [Source](https://github.com/Androz2091/discord-player/blob/a0c651a/packages/extractor/src/extractors/SpotifyExtractor.ts#L18)