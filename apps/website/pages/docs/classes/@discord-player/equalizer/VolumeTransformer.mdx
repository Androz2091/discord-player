...
- [Source](https://github.com/Androz2091/discord-player/blob/e7a50df/packages/equalizer/src/audio/VolumeTransformer.ts#L9)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e7a50df/packages/equalizer/src/audio/VolumeTransformer.ts#L38)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e7a50df/packages/equalizer/src/audio/VolumeTransformer.ts#L26)
### public  toString(): string
- [Source](https://github.com/Androz2091/discord-player/blob/e7a50df/packages/equalizer/src/audio/VolumeTransformer.ts#L58)
### public  toggle(): void
