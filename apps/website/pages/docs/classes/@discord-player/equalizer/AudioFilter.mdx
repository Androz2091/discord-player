...
## Properties
### private  _pulsatorConfig: \{ dI: number,hz: number,x: number }
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L18)
### private  _tremoloConfig: \{ depth: number,frequency: number,phase: number }
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L23)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L17)
...
### public  tremolo: \{ depth: number,frequency: number,phase: number }
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L67)
...
### public  applyFilters(byte, idx): number
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| byte | number | ❌ | - |
| idx | number | ❌ | - |
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L87)
### public  applyRotation(int, idx): number
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| int | number | ❌ | - |
| idx | number | ❌ | - |
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L98)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L105)
...
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| filters | Array\<'8D' \| 'Tremolo'> | ❌ | - |


- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L57)
...
- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L37)
### public  setTremolo(__namedParameters): void
| Parameter | Type | Optional | Description |
| ----------- | ----------- | ----------- | ----------- |
| __namedParameters | \{ depth: number,frequency: number,phase: number } | ❌ | - |


- [Source](https://github.com/Androz2091/discord-player/blob/0ea7a3e/packages/equalizer/src/audio/AudioFilter.ts#L47)
### public  toggle(): void
