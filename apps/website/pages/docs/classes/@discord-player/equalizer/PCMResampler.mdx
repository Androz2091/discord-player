...
- [Source](https://github.com/Androz2091/discord-player/blob/e6e6eb7/packages/equalizer/src/audio/PCMResampler.ts#L9)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e6e6eb7/packages/equalizer/src/audio/PCMResampler.ts#L33)
...
- [Source](https://github.com/Androz2091/discord-player/blob/e6e6eb7/packages/equalizer/src/audio/PCMResampler.ts#L24)
### public  toggle(): void
