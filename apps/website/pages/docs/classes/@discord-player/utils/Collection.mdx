...
- [Source](https://github.com/Androz2091/discord-player/blob/caddfb3/packages/utils/src/Collection.ts#L4)
...
- [Source](https://github.com/Androz2091/discord-player/blob/caddfb3/packages/utils/src/Collection.ts#L9)
...
- [Source](https://github.com/Androz2091/discord-player/blob/caddfb3/packages/utils/src/Collection.ts#L21)
...
- [Source](https://github.com/Androz2091/discord-player/blob/caddfb3/packages/utils/src/Collection.ts#L15)
